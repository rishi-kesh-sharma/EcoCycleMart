...
import { SELLER_SHOP_PLACEHOLDER_IMAGE } from "../../static/data";
  ...
  const addToCartHandler = (id) => {
    ...
    if (isItemExists) {
      ...
      if (data.stock < 1) {
        ...
        const cartData = {
          ...data,
          shopId: data.shopId ?? data.shop.id,
          qty: count,
        };
      ...
      {data ? (
        <div className={`${styles.section} w-[90%] 800px:w-[80%] `}>
          <div className="w-full py-5">
            <div className="block w-full 800px:flex gap-[2rem]">
              ...
              <div className="w-full 800px:w-[50%] pt-5 text-sm">
                <h1 className={`${styles.productTitle}`}>{data.name}</h1>
                <p>{data.description.slice(0, DESCRIPTION_MAX_LENGTH)}</p>
          ...
          <div className="w-full 800px:w-[50%]">
            <Link to={`/shop/preview/${data.shop._id ?? data.shop.id}`}>
              <div className="flex items-center">
                <img
                  src={`${
                    data?.shop?.avatar?.url ?? SELLER_SHOP_PLACEHOLDER_IMAGE
                  }`}
                  className="w-[50px] h-[50px] rounded-full"
                  alt=""
                />
            ...
            <p className="pt-2 text-sm">{data.shop.description}</p>
          </div>
