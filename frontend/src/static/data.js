...
import { normalized_categories_top_n } from "./categories";
...
export const categoriesData = normalized_categories_top_n.map(
  (category, index) => {
    return {
      id: index + 1,
      title: category,
...
export const SELLER_SHOP_PLACEHOLDER_IMAGE =
